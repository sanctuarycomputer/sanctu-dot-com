...
(clippy.Agent = function(a, b, c) {
  ...
  (clippy.Agent.prototype = {
    ...
    moveTo: function(a, b, c) {
      ...
      c === undefined && (c = 1e3),
        this._addToQueue(function(d) {
          if (c === 0) {
            this._el.css({ top: b, left: a }), this.reposition(), d();
            return;
          }
          if (!this.hasAnimation(e)) {
            this._el.animate({ top: b, left: a }, c, d);
            return;
          }
      ...
      return this.hasAnimation(a)
        ? (b === undefined && (b = 5e3),
          this._addToQueue(function(d) {
            var e = !1,
              f = function(a, b) {
                b === clippy.Animator.States.EXITED &&
                  ((e = !0), c && c(), d());
              };
            b &&
              window.setTimeout(
    ...
    _calculateClickOffset: function(a) {
      var b = a.pageX,
        c = a.pageY,
        d = this._el.offset();
      return { top: c - d.top, left: b - d.left };
    },
    ...
    _draw: function() {
      ...
      for (var b = 0; b < this._overlays.length; b++)
        if (b < a.length) {
          var c = a[b],
            d = -c[0] + 'px ' + -c[1] + 'px';
          this._overlays[b].css({ 'background-position': d, display: 'block' });
  ...
  (clippy.Balloon.prototype = {
    ...
    _position: function(a) {
      ...
      this._balloon.css({ top: h, left: g }),
