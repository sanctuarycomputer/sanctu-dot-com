  ...
  <>
    ...
    <div 
      ...
      >
        ...
        <div className="flex flex-row justify-between items-start pt1 pl1 pr1 pb4">
          ...
          <div className="Col2 flex flex-row justify-between items-start px1">
            <div className="Overlay__sign-up-form none md:block col-2">
              <SignUpForm 
